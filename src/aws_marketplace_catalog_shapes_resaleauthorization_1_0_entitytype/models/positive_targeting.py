...
class PositiveTargeting(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.buyer_accounts:
            for _item in self.buyer_accounts:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "BuyerAccounts": [BuyerAccount.from_dict(_item) for _item in obj.get("BuyerAccounts")] if obj.get("BuyerAccounts") is not None else None
        })
        return _obj
