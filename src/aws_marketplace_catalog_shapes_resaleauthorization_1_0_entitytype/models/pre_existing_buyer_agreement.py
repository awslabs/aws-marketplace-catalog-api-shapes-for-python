...
class PreExistingBuyerAgreement(BaseModel):
    """
    PreExistingBuyerAgreement
    """ # noqa: E501
    acquisition_channel: Optional[StrictStr] = Field(default=None, alias="AcquisitionChannel")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PreExistingBuyerAgreement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PreExistingBuyerAgreement from a dict"""
        if obj is None:
            return None
