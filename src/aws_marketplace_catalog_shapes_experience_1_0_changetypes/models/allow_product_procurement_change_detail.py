...
class AllowProductProcurementChangeDetail(BaseModel):
    """
    AllowProductProcurementChangeDetail
    """ # noqa: E501
    products: Annotated[List[Product], Field(min_length=1, max_length=50)] = Field(alias="Products")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllowProductProcurementChangeDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllowProductProcurementChangeDetail from a dict"""
        if obj is None:
            return None
