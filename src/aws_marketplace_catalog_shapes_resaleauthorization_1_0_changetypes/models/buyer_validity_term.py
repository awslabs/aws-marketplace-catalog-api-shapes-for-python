...
class BuyerValidityTerm(BaseModel):
    """
    BuyerValidityTerm
    """ # noqa: E501
    type: BuyerValidityTermType = Field(alias="Type")
    maximum_agreement_start_date: Annotated[str, Field(strict=True)] = Field(alias="MaximumAgreementStartDate")
    __properties: ClassVar[List[str]] = ["Type", "MaximumAgreementStartDate"]

    @field_validator('maximum_agreement_start_date')
    def maximum_agreement_start_date_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BuyerValidityTerm from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of BuyerValidityTerm from a dict"""
        if obj is None:
            return None
