...
class UpdatePaymentScheduleTermsChangeDetail(BaseModel):
    ...
    """ # noqa: E501
    terms: Annotated[List[UpdatePaymentScheduleTerm], Field(min_length=0, max_length=1)] = Field(alias="Terms")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Terms": [UpdatePaymentScheduleTerm.from_dict(_item) for _item in obj.get("Terms")] if obj.get("Terms") is not None else None
        })
        return _obj
