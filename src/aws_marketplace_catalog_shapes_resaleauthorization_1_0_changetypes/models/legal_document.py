...
class LegalDocument(BaseModel):
    ...
    url: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="Url")
    ...
    def url_validate_regular_expression(cls, value):
        ...
        if not re.match(r"https?:\/\/(www\.)?[-a-zA-Z0-9@._]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9@_\+.\/\/]*)", value):
            raise ValueError(r"must validate the regular expression /https?:\/\/(www\.)?[-a-zA-Z0-9@._]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9@_\+.\/\/]*)/")
        return value
