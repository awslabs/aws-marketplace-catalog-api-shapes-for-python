...
class LegalTerm(BaseModel):
    ...
    LegalTerm
    """ # noqa: E501
    type: Optional[LegalTermType] = Field(default=None, alias="Type")
    documents: Optional[Annotated[List[LegalDocument], Field(min_length=1)]] = Field(default=None, alias="Documents")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Type": obj.get("Type"),
            "Documents": [LegalDocument.from_dict(_item) for _item in obj.get("Documents")] if obj.get("Documents") is not None else None
        })
        return _obj
