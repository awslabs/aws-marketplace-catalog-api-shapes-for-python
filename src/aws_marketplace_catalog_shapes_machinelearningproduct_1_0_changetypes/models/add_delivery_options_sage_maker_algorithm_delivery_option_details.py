...
class AddDeliveryOptionsSageMakerAlgorithmDeliveryOptionDetails(BaseModel):
    """
    ...
    recommended_instance_types: SageMakerAlgorithmRecommendedInstanceTypes = Field(alias="RecommendedInstanceTypes")
    sage_maker_algorithm_arn: Annotated[str, Field(strict=True)] = Field(alias="SageMakerAlgorithmArn")
    access_role_arn: Annotated[str, Field(strict=True)] = Field(alias="AccessRoleArn")
    __properties: ClassVar[List[str]] = ["UsageInstructions", "SampleNotebookUrl", "RepositoryUrl", "InputProperties", "OutputProperties", "RecommendedInstanceTypes", "SageMakerAlgorithmArn", "AccessRoleArn"]
    ...
    @field_validator('sage_maker_algorithm_arn')
    def sage_maker_algorithm_arn_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^arn:aws:sagemaker:[a-z0-9-]{4,24}:[0-9]{12}:algorithm\/\S{1,2048}$", value):
            raise ValueError(r"must validate the regular expression /^arn:aws:sagemaker:[a-z0-9-]{4,24}:[0-9]{12}:algorithm\/\S{1,2048}$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddDeliveryOptionsSageMakerAlgorithmDeliveryOptionDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddDeliveryOptionsSageMakerAlgorithmDeliveryOptionDetails from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "SageMakerAlgorithmArn": obj.get("SageMakerAlgorithmArn"),
