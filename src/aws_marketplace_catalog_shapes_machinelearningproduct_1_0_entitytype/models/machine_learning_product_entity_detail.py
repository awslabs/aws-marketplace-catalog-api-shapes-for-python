...
class MachineLearningProductEntityDetail(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Versions", "Description", "PromotionalResources", "SupportInformation", "Dimensions", "Targeting", "RegionAvailability"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MachineLearningProductEntityDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MachineLearningProductEntityDetail from a dict"""
        if obj is None:
            return None
