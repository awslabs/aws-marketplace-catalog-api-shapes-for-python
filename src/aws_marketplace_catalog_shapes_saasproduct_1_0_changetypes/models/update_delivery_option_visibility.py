...
class UpdateDeliveryOptionVisibility(BaseModel):
    ...
    target_visibility: Optional[UpdateDeliveryOptionsTargetVisibility] = Field(default=None, alias="TargetVisibility")
    targeting: Optional[Targeting] = Field(default=None, alias="Targeting")
    __properties: ClassVar[List[str]] = ["Id", "TargetVisibility", "Targeting"]

    @field_validator('id')
    def id_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^do-[a-zA-Z0-9]+$", value):
