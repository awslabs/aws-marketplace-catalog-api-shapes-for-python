...
class PromotionalMedia(BaseModel):
    ...
    PromotionalMedia
    """ # noqa: E501
    type: Annotated[str, Field(strict=True, max_length=10)] = Field(description="Should be either 'Image' or 'Video'", alias="Type")
    url: Annotated[str, Field(strict=True)] = Field(alias="Url")
    sha256_base64: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="Sha256Base64")
    title: Annotated[str, Field(strict=True, max_length=100)] = Field(alias="Title")
    preview: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="Preview")
    thumbnail: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="Thumbnail")
    ...
    @field_validator('sha256_base64')
    def sha256_base64_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def preview_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def thumbnail_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
