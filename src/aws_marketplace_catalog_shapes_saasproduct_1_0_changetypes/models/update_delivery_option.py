...
class UpdateDeliveryOption(BaseModel):
    ...
    details: UpdateDeliveryOptionDetails = Field(alias="Details")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "Details": UpdateDeliveryOptionDetails.from_dict(obj.get("Details")) if obj.get("Details") is not None else None
        })
        return _obj
