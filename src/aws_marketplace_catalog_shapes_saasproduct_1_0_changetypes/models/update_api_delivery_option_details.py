...
class UpdateApiDeliveryOptionDetails(BaseModel):
    """
    ...
    endpoints: Optional[Annotated[List[ApiEndpoint], Field(min_length=1, max_length=1)]] = Field(default=None, alias="Endpoints")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateApiDeliveryOptionDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateApiDeliveryOptionDetails from a dict"""
        if obj is None:
            return None
