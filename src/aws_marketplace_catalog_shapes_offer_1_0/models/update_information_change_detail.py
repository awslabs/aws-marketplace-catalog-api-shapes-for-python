...
class UpdateInformationChangeDetail(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, alias="Description")
    pre_existing_agreement: Optional[PreExistingAgreement] = Field(default=None, alias="PreExistingAgreement")
    __properties: ClassVar[List[str]] = ["Name", "Description", "PreExistingAgreement"]
