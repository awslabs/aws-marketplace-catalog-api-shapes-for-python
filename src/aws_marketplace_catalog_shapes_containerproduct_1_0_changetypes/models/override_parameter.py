...
class OverrideParameter(BaseModel):
    ...
    OverrideParameter
    """ # noqa: E501
    key: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(alias="Key")
    default_value: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=150)]] = Field(default=None, alias="DefaultValue")
    metadata: Optional[Metadata] = Field(default=None, alias="Metadata")
    __properties: ClassVar[List[str]] = ["Key", "DefaultValue", "Metadata"]
