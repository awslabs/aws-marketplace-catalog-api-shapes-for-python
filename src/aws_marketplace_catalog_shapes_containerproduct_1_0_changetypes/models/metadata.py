...
class Metadata(BaseModel):
    ...
    Metadata
    """ # noqa: E501
    label: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(alias="Label")
    description: Annotated[str, Field(strict=True, max_length=200)] = Field(alias="Description")
