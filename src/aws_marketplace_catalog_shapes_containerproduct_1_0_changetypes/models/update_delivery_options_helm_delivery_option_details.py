...
class UpdateDeliveryOptionsHelmDeliveryOptionDetails(BaseModel):
    """
    ...
    compatible_services: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=2)]] = Field(default=None, alias="CompatibleServices")
    ...
    __properties: ClassVar[List[str]] = ["Description", "UsageInstructions", "ContainerImages", "CompatibleServices", "HelmChartUri", "QuickLaunchEnabled", "ReleaseName", "Namespace", "MarketplaceServiceAccountName", "OverrideParameters", "DeliveryOptionTitle"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UpdateDeliveryOptionsHelmDeliveryOptionDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UpdateDeliveryOptionsHelmDeliveryOptionDetails from a dict"""
        if obj is None:
            return None
