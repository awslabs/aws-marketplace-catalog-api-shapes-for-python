...
class UpdateDeliveryOptionsChangeDetail(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Version": UpdateDeliveryOptionsVersion.from_dict(obj["Version"]) if obj.get("Version") is not None else None,
            "DeliveryOptions": [UpdateDeliveryOption.from_dict(_item) for _item in obj["DeliveryOptions"]] if obj.get("DeliveryOptions") is not None else None
        })
        return _obj
