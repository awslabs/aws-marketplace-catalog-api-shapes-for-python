...
class DeploymentResource(BaseModel):
    ...
    DeploymentResource
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, alias="Name")
    url: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, alias="Url")
