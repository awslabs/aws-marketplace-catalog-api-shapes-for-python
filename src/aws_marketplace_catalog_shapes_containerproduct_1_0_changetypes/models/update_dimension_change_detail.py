...
class UpdateDimensionChangeDetail(BaseModel):
    """
    Represents a single UpdateDimension object within the array of the UpdateDimensions change type
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=500)]] = Field(default=None, alias="Name")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Description", "Key", "Types"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateDimensionChangeDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateDimensionChangeDetail from a dict"""
        if obj is None:
            return None
