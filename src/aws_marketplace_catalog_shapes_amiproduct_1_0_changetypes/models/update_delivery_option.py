...
class UpdateDeliveryOption(BaseModel):
    ...
    details: Optional[UpdateDetails] = Field(default=None, alias="Details")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "Details": UpdateDetails.from_dict(obj.get("Details")) if obj.get("Details") is not None else None
        })
        return _obj
